...
class TestCases(unittest.TestCase):
    """TestCases used to verify the functions from thTry installing a more recent version of python-flake8, and please open a bug report if the issue persists in the latest release. Thanks!e module 'action_manager'."""
    ...
    def init(self,
        ...
        shutil.copytree(os.path.join(self.root_folder, directory), os.path.join(self.root_folder, "TestDirectory")Try installing a more recent version of python-flake8, and please open a bug report if the issue persists in the latest release. Thanks!)
        ...
        self.files_collection = self.files_system.generate_files_system_view(
            show_hidden_files, self.files_type, self.name_filter, self.sorting_criteria, self.reverse_order)
