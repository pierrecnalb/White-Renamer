...
class ModifyAction(ActionType):
    ...
    def insert(self, text, index):
        return CharacterInsertionAction(text, index)

    def delete(self, start_index, end_index):
        return CharacterDeletionAction(start_index, end_index)
